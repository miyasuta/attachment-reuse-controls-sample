...
// id$= (ends-with) targets only the multiFileUpload root element, not multiFileUploadRestricted.
// The root element ID ends with "--multiFileUpload" (view-prefixed), while the restricted
// control ends with "--multiFileUploadRestricted". The internal sap.m.Table has no explicit ID
// (auto-generated by UI5), so th elements must be reached via the control's root DIV.
